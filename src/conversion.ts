...
export function srgb_transfer_function_inv(a: number) { return 0.04045 < a ? Math.pow((a + 0.055) / 1.055, 2.4) : a / 12.92; }
...
export function srgb_to_okhsl(r: number, g: number, b: number) {
    ...
    if (C < C_mid) {
        ...
        let k_0 = C_mid;
        let k_1 = 0.3125 * C_mid * (C_mid / C_0);
